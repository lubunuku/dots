...
// static const unsigned int gappiv         = 12;  /* horiz inner gap between windows */
// static const unsigned int gappoh         = 12;  /* vert inner gap between windows */
// static const unsigned int gappov         = 12;  /* horiz outer gap between windows and screen edge */
...
#endif // BAR_HEIGHT_PATC
#if BAR_PADDING_PATCH
static const int vertpad                 = 12;  /* vertical padding of bar */
static const int sidepad                 = 75;  /* horizontal padding of bar */
...
static char normbordercolor[]            = "#302D41";
static char normfloatcolor[]             = "#302D41";
...
// static char titlenormfgcolor[]           = "#575268";
...
// static char tagsselbgcolor[]             = "#302D41";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_s,          zoom,                   {0} },
	#if VANITYGAPS_PATCH
	{ MODKEY,                       XK_comma,      incrogaps,              {.i = -4 } },
	{ MODKEY,                       XK_period,     incrogaps,              {.i = +4 } },
	{ MODKEY|ControlMask,           XK_comma,      incrigaps,              {.i = -4 } },
	{ MODKEY|ControlMask,           XK_period,     incrigaps,              {.i = +4 } },
	...
	{ MODKEY|ShiftMask,             XK_period,     togglegaps,             {0} },
	{ MODKEY|ShiftMask,             XK_comma,      defaultgaps,            {0} },
	#endif // VANITYGAPS_PATCH
...
static const char *powermenu[] = { "/home/lubunuku/.local/bin/powermenu", NULL };

static Button buttons[] = {
	/* click                event mask           button          function        argument */
	#if BAR_STATUSBUTTON_PATCH
	{ ClkButton,            0,                   Button1,        spawn,          {.v = powermenu } },
	#endif // BAR_STATUSBUTTON_PATCH
	...
	{ ClkRootWin,           0,                   Button3,        spawn,          {.v = powermenu} },
};
